  ...
  return (
    <Container>
      ...
      <div className="text-center">
        {/* <p className="text-lg">Hãy liên hệ qua email để được giải đáp.</p> */}
      </div>
      ...
      <div className="my-10 grid md:grid-cols-2">
        <div className="my-10">
          ...
          <p className="mt-5 max-w-sm">
            Hãy liên hệ qua email để được giải đáp
          </p>
        ...
        <div>
          <form onSubmit={handleSubmit(onSubmit)} className="my-10">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                {...register("email", {
                  required: "Hãy nhập địa chỉ email nhé",
                  pattern: {
                    value: /^\S+@\S+$/i,
                    message: "Hãy nhập địa chỉ email nhé"
                  }
                })}
              />
              {errors.email && (
          ...
          {isSubmitSuccessful && isSuccess && (
            <div className="mt-3 text-center text-sm text-green-500">
              {message ||
                "Thành công. Tin nhắn đã được gửi đến tôi. Cảm ơn bạn"}
            </div>
          )}
          {isSubmitSuccessful && !isSuccess && (
            <div className="mt-3 text-center text-sm text-red-500">
              {message || "Hình như có gì đó lỗi. Hãy thử lại."}
            </div>
          )}
        </div>
      </div>
